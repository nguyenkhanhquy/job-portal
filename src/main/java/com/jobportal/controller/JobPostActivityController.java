...
import com.jobportal.service.JobSeekerApplyService;
import com.jobportal.service.JobSeekerSaveService;
    ...
    public String searchJobs(Model model,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService.getCandidatesJob(
                ...
                for (JobPostActivity jobActivity : jobPost) {
                    ...
                    for (JobSeekerApply jobSeekerApply : jobSeekerApplyList) {
                        if (Objects.equals(jobActivity.getPostedById(), jobSeekerApply.getJob().getJobPostId())) {
                    ...
                    for (JobSeekerSave jobSeekerSave : jobSeekerSaveList) {
                        if (Objects.equals(jobActivity.getPostedById(), jobSeekerSave.getJob().getJobPostId())) {
